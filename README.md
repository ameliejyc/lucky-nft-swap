...
## Created using Starter React Typescript Ethers.js Hardhat Project
...
Additionally, this repo is a companion project to [ChainShot](https://www.chainshot.com)'s [How to Build a React Dapp with Hardhat and MetaMask](https://medium.com/p/9cec8f6410d3) Medium article.
...
Pull this project down from GitHub, cd into the project directory and run the following commands to get setup and running. You must have node v16.13.1 as well as yarn already installed.
